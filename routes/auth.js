...
import {firebaseAuth,login,signup,registerUser,logoutUser,loginwithPassword,loginConfirm,changePassword,pinCreate,pinform,pinVerify,deleteAccount,savePublicKey,fetchPublicKey,sendEncryptData} from"../controllers/userController.js";
...
router.get("/userPublicKey/:id",validToken,fetchPublicKey)
